/*
McT's note: this is modified from the example.  https://code.google.com/archive/p/arduino-pwm-frequency-library/downloads
I need to test different values to get different speeds.
*/
/*
...
int motorLeft = 9;                // the pin that the LED is attached to
int motorRight = 10;
int motorSpeedLeft = 1;         // how bright the LED is
int motorSpeedRight = 1;
...
void setup()
{
  ...
  //sets the frequency for the specified pin
   success = SetPinFrequencySafe(motorLeft, frequency);
   success = SetPinFrequencySafe(motorRight, frequency);
